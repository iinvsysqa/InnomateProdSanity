...
public class AddDevicePage extends GenericWrappers {
	...
	@FindBy(xpath = "//*[@resource-id='Add SwitchboardButton']")
	private WebElement addSwitchBoard;
...
//    @FindBy(xpath = "//*[@resource-id='Start_Pairing_Button_Text']")
	...
	private WebElement PanelsaveBtn() {
		return driver.findElement(By.xpath("(//android.widget.TextView[@text=\"Save\"])[2]"));
	}
	...
	public void clickAddSwitchBoardButton() {
	...
	public void clickSwitchType1Dropdown() {
		clickbyXpath(switchType1DropdownBtn, " Click switch type Drop down ");
	}
...
//		clickbyXpath(switchTypeFridgeButton, " Click Fridge option ");
	...
	public void clickAddPanelSaveBtn() {
		clickbyXpath(panelNameSaveBtn, " Panel name save button ");
	}
...
public List<WebElement> getSwitchTextboxes() {
    // Locate all EditText elements with the specified text
