...
public class SignUpPage extends GenericWrappers {
	...
	@FindBy(xpath = "//*[@resource-id='nameInput']")
	...
	@FindBy(xpath = "//*[@resource-id='schoolInput']")
	private WebElement answerField1;
	
	@FindBy(xpath = "//*[@resource-id='movieInput']")
	private WebElement answerField2;
	
			
	@FindBy(xpath = "//*[@resource-id='Register_CheckBox']")
	...
	public WebElement getHierarchyTextField(int level) {
	    String xpath = String.format("//android.widget.EditText[@text='Type the name for Level %d']", level);
	    return driver.findElement(By.xpath(xpath));
	}
	
	public WebElement getDatabaseIconByIndex(int index) {
	...
	public void enterUserName(String username) {
		entervaluebyXpath(userNameField, " Enter User Name " , username);
	}
	
	public void enterHierarchy(String hierarchy, int level) {
		entervaluebyXpath(getHierarchyTextField(level), " Enter Hierarchy Level "+ level , hierarchy);
	}
	
	
	public void enterName(String name) {
		entervaluebyXpath(nameField, " Email name " , name);
	}
	
	public void enterPassword(String password) {
		entervaluebyXpath(passwordTextBox, " Enter password field " , password);
	}

	public void enterConfirmPassword(String comfirmpassword) {
		entervaluebyXpath(confirmPasswordTextBox, " Enter password field " , comfirmpassword);
	}
	
	public void enteranswer1(String answer1) {
		entervaluebyXpath(answerField1, " Enter the Security Answer " , answer1);
	}
	...
	public void clickSignUpNextButton() {
		clickbyXpath(signUpnextButton, " Sign Up Page Next Button ");
