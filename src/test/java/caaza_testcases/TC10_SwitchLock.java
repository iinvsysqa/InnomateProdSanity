...
public class TC10_SwitchLock  extends MobileAppWrappers{
...
//			//logout
			...
			notificationpage.CheckSharedUserNotification(userName);
			userpage.navigateBack();
...
//			Thread.sleep(5000);
//			homepage.navigateback();
//			analytics.navigateAnalyticsPage();//			analytics.getenergydurationvalue();
//			homepage.navigateback();
//			
//			//turn on app for 1 min
//			homepage.enterFirstcard();
